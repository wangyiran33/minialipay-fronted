const { List, InputItem, WhiteSpace } = window["antd-mobile"];
const { createForm } = window["rc-form"];
...
const TestPageWrapper = createForm()(TestPage);
ReactDOM.render(<TestPageWrapper />, mountNode);